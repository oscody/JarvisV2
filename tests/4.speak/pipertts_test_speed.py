...
# Playback using playsound
start_playsound = time.time()
playsound('Voice/pipertts.wav')
end_playsound = time.time()
playsound_time = end_playsound - start_playsound
print(f"Time taken to play back using playsound: {playsound_time:.4f} seconds")
