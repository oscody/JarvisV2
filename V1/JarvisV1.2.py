...
def jarvis():
    try:
        ...
        # idea 
        # make to loop so that it checks for audio x number of times and saves that 
        # pattern when x number of times it reached goes back to listening for wake word to enter in loop 
